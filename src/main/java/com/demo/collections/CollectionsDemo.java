...
public class CollectionsDemo {
    ...
    public static void demonstrateConvenienceMethods() {
        ...
        System.out.println("移除3后的数字: " + numbers);
        ...
        languages.sort((s1, s2) -> s2.compareTo(s1));
        languages.forEach(fruit -> System.out.print(fruit + " "));
        System.out.println();
        ...
        // compute方法
        System.out.println("李四调整前: " + scoreMap.get("李四"));
    ...
    public static void demonstrateConcurrentHashMapEnhancements() {
        ...
        // search方法parallelismThreshold1（parallelismThreshold）
        // 表示并行阈值为 1，意思是如果集合大小超过 1，就可能使用并行搜索。
        // 这里设置为 1，几乎总是会启用并行搜索（取决于集合大小和实现）
        ...
        Integer totalStock = concurrentMap.reduce(1,
                ...
                (v1, v2) -> v1 + v2);
        // 或者
        // Integer totalStock1 = concurrentMap.reduce(1,
        //     (key, value) -> value,
        //         Integer::sum);
        // 最大值查找
        // Integer totalStock2 = concurrentMap.reduce(1,
        //     (key, value) -> value,
        //         Integer::max);
        System.out.println("总库存: " + totalStock);
        Integer maxValue = concurrentMap.reduceValues(1, Math::max);
    ...
    public static void demonstrateToArrayEnhancement() {
        System.out.println("\n=== toArray方法增强演示, 不可变Array ===");
        ...
        String[] oldWay1 = programmingLanguages.toArray(new String[]{"Java", "2"}); // 入参仅仅提供了类, 这两个元素不会追加进去
        System.out.println("传统方式转数组: " + Arrays.toString(oldWay));
        System.out.println("传统方式转数组1: " + Arrays.toString(oldWay1));
    ...
    public static void demonstrateStreamCollectionOperations() {
        System.out.println("\n=== Stream集合操作演示 ===");
        ...
        // 或者
        Map<String, List<Employee>> byDepartment1 = employees.stream()
